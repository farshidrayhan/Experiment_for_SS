...
for i in cursor:
    ...
    hsa = x + "_" + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/Enzyme_seqs/' + hsa + '.seq.spd3_bigram.txt', 'r')
    x = file_read.readline()
    l = x.rstrip('\n').split(',')
    hsa_dict_auto[hsa] = l
...
##########################################################
cnx.close()###################################################
file = open('/home/farshid/Desktop/enzyme_dataset_1477.txt', 'w')
...
for i in cursor:
    ...
    print(int(counter/291920*100),"% completed ")
    counter += 1
...
print("counter for cls 1  ", counter_for_class_1)
# print(len(my_list) )
# print(my_list[1281])
