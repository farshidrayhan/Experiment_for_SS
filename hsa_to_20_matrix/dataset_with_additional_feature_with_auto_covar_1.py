...
for i in cursor:
    ...
    hsa = x + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/GPCR_seqs/' + hsa + '.txt', 'r')
...
for i in cursor:
    ...
    hsa = x + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/GPCR_seqs/' + hsa + '.txt.spd3_spd3.txt', 'r')
    x = file_read.readline()
    l = x.rstrip('\n').split(',')
...
##########################################################
cnx.close()###################################################
file = open('/home/farshid/Desktop/gpcr_dataset_1404.txt', 'w')
