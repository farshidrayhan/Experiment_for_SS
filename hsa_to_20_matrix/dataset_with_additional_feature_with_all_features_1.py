...
query = ("select distinct(Protein) from second_connection")
x = cursor.execute(query)
...
for i in cursor:
    ...
    hsa = x + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/IR_seqs/' + hsa + '.txt', 'r')
...
for i in cursor:
    ...
    hsa = x + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/IR_seqs/' + hsa + '.txt.spd3_spd3.txt', 'r')
    x = file_read.readline()
    l = x.rstrip('\n').split(',')
...
for i in cursor:
    ...
    hsa = x + y
    # print(hsa)
    file_read = open('/home/farshid/Desktop/IR_seqs/' + hsa + '.txt.spd3_bigram.txt', 'r')
    x = file_read.readline()
    l = x.rstrip('\n').split(',')
    hsa_dict_auto[hsa] = l
...
query = ("select DrugId,Protein,Relation from second_connection limit 300000")
x = cursor.execute(query)
counter = 0
...
file = open('/home/farshid/Desktop/ir_dataset_1282.txt', 'w')
...
for i in cursor:
    ...
    str5 = ','.join(str(i) for i in hsa_dict_bigram[hsa])  # here hSa bigram represents auto covariance

    str6 = ','.join(str(i) for i in hsa_dict_auto[hsa])    # here hSa covariance represents auto bigram
    ...
    # for 1477 features
    # write_this_str = str1 + "," + str2 + "," + str3 + "," + str5 + "," + str6 + "," + str(str4) + "\n"
    # for 1404 features
