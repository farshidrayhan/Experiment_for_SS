...
for hsa in hsa_list_temp:
    ...
    # hsa  = hsa_list_temp[z]
    # print(hsa)
    file_read = open('/home/farshid/Desktop/Spider files/' + hsa, 'r')
    ...
    num_lines = sum(1 for line in open('/home/farshid/Desktop/Spider files/' + hsa, 'r'))
    ...
    file = open('/home/farshid/Desktop/Enzyme_seqs/' + hsa + '_spd3.txt', 'w')
